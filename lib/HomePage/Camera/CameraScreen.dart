    ...
    switch (_model) {
      case ssd:
        modelResult = await Tflite.loadModel(
            labels:
                "assets/tflite/labels.txt", // Add the location of .txt model in the quotes
            model:
                "assets/tflite/lobster_detection.tflite" // Add the location of .tflite model in the quotes
            );
    } // switch
    print(modelResult);
  } // loadModel Function
